...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Au Bon Vivant — Restaurant gastronomique à Bergerac" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Au Bon Vivant" },
      { property: "og:title", content: "Au Bon Vivant — Restaurant gastronomique à Bergerac" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Italiana&family=Inter:wght@300;400;500;600&display=swap",
      },
    ],
  }),
